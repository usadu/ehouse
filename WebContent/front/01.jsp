...
<script type="text/javascript">
	$(function(){
		...
		* 动态添加option列表
		*/
		$.post("${pageContext.request.contextPath}/FrontController",{op:"addoption"},function(data){
			...
			初始地区全部显示 
			*/
			 $.post("${pageContext.request.contextPath}/FrontController",{op:"queryallbyareaid",areaid:$("#areas").val()},function(data){
			 ...
			 /*
				...
				*/
				$("#areas").change(function(){
					$.post("${pageContext.request.contextPath}/FrontController",{op:"queryallbyareaid",areaid:$(this).val()},function(data){
				 		houselist=JSON.parse(data);
						$("#housetable").html("");
						$.each(houselist,function(i){
							$("#housetable").append("<tr><td class='border_lf'>"+houselist[i].h_name+"</td>"+
		...
		*/
		...
		动态插入类型,户型
		*/
		 $.post("${pageContext.request.contextPath}/FrontController",{op:"houseType"},function(data){
			...
			$(".thistype").click(function(){
				...
				if($(this).text()=="房源"){
					$.post("${pageContext.request.contextPath}/FrontController",{op:"houseunits"},function(data){
						...
						$("#hu .thisunits").click(function(){
							$.post("${pageContext.request.contextPath}/FrontController",{op:"qbyuntisname",name:$(this).text(),areaid:$("#areas").val()},function(data){
								hlist=JSON.parse(data);
								$("#housetable").html("");
								$.each(hlist.data,function(i){
									$("#housetable").append("<tr><td class='border_lf'>"+hlist.data[i].h_name+"</td>"+
								...
								$("#prepage").click(function(){
									...
									pre=yema-1;
									if(yema>1){
									$.post("${pageContext.request.contextPath}/FrontController",
											{op:"qbyuntisname",
				...
				$.post("${pageContext.request.contextPath}/FrontController",{op:"queryhousebytname",name:$(this).text(),areaid:$("#areas").val()},function(data){
					hlist=JSON.parse(data);
					$("#housetable").html("");
					$.each(hlist.data,function(i){
						  $("#housetable").append("<tr><td class='border_lf'>"+hlist.data[i].h_name+"</td>"+
...
<body>
				...
				<div class="nav-collapse collapse">
					<ul class="nav pull-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown">您好，夜凌云 <b class="caret"></b></a>
	...
	<div class="navbar menubar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				<a href="/?site=1" title="e选房系统" class="brand"> <img
					src="/Content/images/menubar_logo.png" alt="e选房系统" /></a>
				<div class="nav-collapse collapse">
					<div class="pull-left">
					...
					<div class="">
						<ul class="nav menubar_nav pull-right">
							...
							<li id="menubar_project"><a
								href="https://mfang.vanke.com/sale/" target="_blank">阳光购房</a></li>
		...
		<div id="main">
			<div class="container">
				...
				<div class="row-fluid">
					<div class="span4">
						<div class="map ">
							您所在的位置：<a href="/?site=1">首页</a> &gt; <a href="/Bidding?site=1">线上开盘</a>
						</div>
					</div>
					<div class="map" id="hu">
					...
					<div class="row-fluid">
						<div class="span3">
							<ul class="column">
								...
								<li><a target="_blank"
									href="http://www.vanke.com/about.aspx">关于我们</a></li>
								<li><a target="_blank"
									href="http://www.vanke.com/contact.aspx">联系我们</a></li>
							</ul>
						</div>
						<div class="span3">
							<ul class="column">
					...
					<div class="row-fluid">
						<div class="span7">
							<ul class="column colum-right">
								<li><a> <img src="/Content/images/bottom_logo.png"
										alt="e选房系统"></a></li>
								<li>
									<h6>e选房系统 版权所有</h6>
